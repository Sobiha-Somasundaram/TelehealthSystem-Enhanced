...
CREATE TABLE `appointments` (
  ...
  CONSTRAINT `appointments_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `appointments` VALUES (1,1,3,'2025-10-12','09:00:00','Fever and headache','Pending','2025-10-10 01:39:04'),(2,2,4,'2025-10-13','14:30:00','Cough and sore throat','Approved','2025-10-10 01:39:04');
...
INSERT INTO `bookings` VALUES (3,6,4,'2025-10-14','11:00:00','Heada','Pending','2025-10-11 00:20:38','Video'),(4,6,3,'2025-10-16','12:00:00','Cold','Pending','2025-10-11 00:25:34','Video'),(5,6,4,'2025-10-14','11:00:00','Cold','Pending','2025-10-11 02:01:55','Video'),(6,6,4,'2025-10-15','10:00:00','Cold','Pending','2025-10-12 01:41:48','Video'),(7,6,3,'2025-10-19','11:00:00','Blood test','Pending','2025-10-14 13:01:40','Video'),(8,6,7,'2025-10-15','16:00:00','visar','Pending','2025-10-14 13:24:46','Video'),(9,6,4,'2025-10-21','09:00:00','Flue','Pending','2025-10-14 13:55:07','Video'),(10,6,3,'2025-10-15','12:00:00','Audio','Pending','2025-10-14 13:56:05','Video'),(11,6,4,'2025-10-15','10:00:00','A','Pending','2025-10-14 14:00:55','Audio'),(12,10,3,'2025-10-16','10:00:00','Fever','Pending','2025-10-14 14:24:02','Audio'),(13,10,4,'2025-10-17','10:00:00','Fever','Pending','2025-10-14 14:54:50','Audio');
...
CREATE TABLE `diagnoses` (
  ...
  CONSTRAINT `fk_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_patient` FOREIGN KEY (`patient_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `diagnoses` VALUES (1,1,2,'Flu and mild fever','Paracetamol 500mg twice daily','General Physician','2025-10-11 12:14:11'),(2,1,3,'Migraine headache','Ibuprofen 200mg as needed','Neurologist','2025-10-11 12:14:11'),(3,2,2,'Seasonal allergies','Cetirizine 10mg at night','Allergy Specialist','2025-10-11 12:14:11');
...
INSERT INTO `prescription_refills` VALUES (1,'Gihani','Panadol',2,'once per week','Pending','2025-10-11 00:39:00',6),(2,'Gihani','Panadol',12,'Cold','Pending','2025-10-12 01:42:32',6),(3,'Gihani','Parasitamol',7,'Cold','Pending','2025-10-12 02:03:52',6),(4,'Gihani','vit D',10,'low vitamin','Pending','2025-10-14 13:02:25',6),(5,'Gihani','visar kulusa',2,'visar muththidum','Pending','2025-10-14 13:25:16',6),(6,'Gihani','elevit',20,'reguler use','Pending','2025-10-14 14:42:24',6),(7,'Rathi','Panadol',20,'fever','Pending','2025-10-14 14:55:10',10);
...
-- Dump completed on 2025-10-15  1:58:02
